...
Pod::Spec.new do |s|
  s.name             = 'CZAESCipher'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CZAESCipher.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/CZ/CZAESCipher'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'CZ' => 'cooper_jx@126.com' }
  s.source           = { :git => 'https://github.com/CZ/CZAESCipher.git', :tag => s.version.to_s }
